...
struct GbtsSP {
  ...
  GbtsSP(const space_point_t *sp, int id, int combined_id, float ClusterWidth)
    ...
    std::cout<<"Jasper: instance of GbtsSP struct was created in Acts/Seeding/GbtsDataStorage.hpp"<<std::endl;
...
class GbtsNode {
 public:
  explicit GbtsNode(const GbtsSP<space_point_t> &spGbts, float minT = -100.0,
                    float maxT = 100.0)
      : m_spGbts(spGbts), m_minCutOnTau(minT), m_maxCutOnTau(maxT) {std::cout<<"Jasper: an instance of GbtsNode was created (cosntructor called) in Acts/Seeding/GbtsDataStorage.hpp"<<std::endl;}

  inline void addIn(int i) {
    std::cout<<"Jasper: GbtsNode member function addIn was called in Acts/Seeding/GbtsDataStorage.hpp. \n takes int as input and doesnt return"<<std::endl;
  ...
  inline void addOut(int i) {
    std::cout<<"Jasper: GbtsNode member function addOut was called in Acts/Seeding/GbtsDataStorage.hpp.\n takes int as input and doesnt return"<<std::endl;
  ...
  inline bool isConnector() const {
    std::cout<<"Jasper: isConnector member function addIn was called in Acts/Seeding/GbtsDataStorage.hpp.\n doesnt have input , returns a bool"<<std::endl;
  ...
  inline bool isFull() const {
    std::cout<<"Jasper: GbtsNode member function isFull was called in Acts/Seeding/GbtsDataStorage.hpp.\n doesnt have input, returns bool"<<std::endl;
...
class GbtsEtaBin {
 public:
  GbtsEtaBin() { 
    ...
    std::cout<<"Jasper: instance of GbtsEtaBin created (constructor called) in Acts/Seeding/GbtsDataStorage.hpp"<<std::endl;
    m_vn.clear(); }

  void sortByPhi() {
    std::cout<<"Jasper: GbtsEtaBin member function sortByPhi was called in Acts/Seeding/GbtsDataStorage.hpp .\n doesnt have input or return"<<std::endl;
  ...
  void generatePhiIndexing(float dphi) {
    ...
    std::cout<<"Jasper: GbtsEtaBin member function generatePhiIndexing was called in Acts/Seeding/GbtsDataStorage.hpp .\n takes float and doesnt return"<<std::endl;
...
class GbtsDataStorage {
 public:
  explicit GbtsDataStorage(const GbtsGeometry<space_point_t> &g) : m_geo(g) {
    std::cout<<"Jasper: instance of GbtsDataStorage created (constructor called) in Acts/Seeding/GbtsDataStorage.hpp"<<std::endl;
  ...
  int addSpacePoint(const GbtsSP<space_point_t> &sp, bool useClusterWidth) {
    ...
    std::cout<<"Jasper: GbtsDataStorage member function addSpacePoint was called in Acts/Seeding/GbtsDataStorage.hpp .\n it takes the GbtsSP<space_point_t> class and bool as input and returns int"<<std::endl;
  ...
  unsigned int numberOfNodes() const {
    ...
    std::cout<<"Jasper: GbtsDataStorage member function numberOfNodes was called in Acts/Seeding/GbtsDataStorage.hpp .\n has no input but returns an unsigned int "<<std::endl;
    unsigned int n = 0;
  ...
  void getConnectingNodes(std::vector<const GbtsNode<space_point_t> *> &vn) {
    ...
    std::cout<<"Jasper: GbtsDataStorage member function getConnectingNodes was called in Acts/Seeding/GbtsDataStorage.hpp .\n has input of a vector of const GbtsNode<space_point_t> and no return"<<std::endl;
    vn.clear();
  ...
  void sortByPhi() {
    std::cout<<"Jasper: GbtsDataStorage member function sortByPhi was called in Acts/Seeding/GbtsDataStorage.hpp .\n has no inputs and doesnt return"<<std::endl;
    for (auto &b : m_etaBins) {
      b.sortByPhi();
    }
  }
  ...
  void generatePhiIndexing(float dphi) {
    ...
    std::cout<<"Jasper: GbtsDataStorage member function generatePhiIndexing was called in Acts/Seeding/GbtsDataStorage.hpp .\n has input of a float and no return"<<std::endl;
    for (auto &b : m_etaBins) {
  ...
  const GbtsEtaBin<space_point_t> &getEtaBin(int idx) const {
    ...
    std::cout<<"Jasper: GbtsDataStorage member function getEtaBin was called in Acts/Seeding/GbtsDataStorage.hpp .\n has input of an int and returns and instance of the GbtsEtaBin<space_point_t> class "<<std::endl;
 ...
 public:
  ...
  GbtsEdge(GbtsNode<space_point_t> *n1, GbtsNode<space_point_t> *n2, float p1,
      ...
      : m_n1(n1), m_n2(n2), m_level(1), m_next(1) {
        ...
        std::cout<<"Jasper: Instance of GbtsEdge created (contructor called in Acts/Seeding/GbtsDataStorage.hpp)"<<std::endl;
    m_p[0] = p1;
    m_p[1] = p2;
    m_p[2] = p3;
    m_p[3] = p4;
  ...
  GbtsEdge() : m_n1(nullptr), m_n2(nullptr), m_level(-1), m_next(-1) {std::cout<<"Jasper: Instance of GbtsEdge created (default constructor called in Acts/Seeding/GbtsDataStorage.hpp)"<<std::endl;}
